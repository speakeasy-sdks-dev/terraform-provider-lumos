...
- `groups` (Attributes Set) Groups assigned as support request approvers. Not Null (see [below for nested schema](#nestedatt--request_config--request_approval_config--approvers--groups))
- `users` (Attributes Set) Users assigned as support request approvers. Not Null (see [below for nested schema](#nestedatt--request_config--request_approval_config--approvers--users))
...
- `groups` (Attributes Set) Groups assigned as support request approvers. Not Null (see [below for nested schema](#nestedatt--request_config--request_approval_config--approvers_stage_2--groups))
- `users` (Attributes Set) Users assigned as support request approvers. Not Null (see [below for nested schema](#nestedatt--request_config--request_approval_config--approvers_stage_2--users))
